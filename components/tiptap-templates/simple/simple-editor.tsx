...
const MainToolbarContent = ({
  ...
  return (
    <>
      ...
      <ToolbarGroup className="bg-white dark:bg-zinc-800 shadow-md text-gray-800 dark:text-white">
  ...
  <>
    <ToolbarGroup className="bg-white dark:bg-zinc-800 shadow-md text-gray-800 dark:text-white">
      <Button
        data-style="ghost"
        onClick={onBack}
        className="bg-white dark:bg-zinc-800 shadow-md text-gray-800 dark:text-white"
      >
...
export function SimpleEditor({
  ...
  setBlogBody: (content: string) => void;
}) {
